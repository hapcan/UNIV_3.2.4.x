...
;==============================================================================
    ...
    #include <univ_3-2-4-1-rev0.inc>                         ;project variables
...
EEPROM      code                                                ;default config
    org 0xF00008
    DE      0x00,0x00,0x00,0xFF             ;power up from defined state as OFF
;            |    |    |    |______ relay coil polarity reversed for all relays
;            |    |    |_________________ automatically saved last relay states
;            |    |_______________ power up relay states are off for all relays
;            |__________________________ power up from defined state (next reg)
;==============================================================================
;===  FIRMWARE CHECKSUM  ======================================================
;==============================================================================
